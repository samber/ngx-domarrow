...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function distNgxDomarrowFesm2015NgxDomarrowJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NgxDomarrowComponent", function () {
      return NgxDomarrowComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgxDomarrowModule", function () {
      return NgxDomarrowModule;
    });
    /* harmony import */
    ...
    var NgxDomarrowComponent =
    /*#__PURE__*/
    function () {
      /**
       * @param {?} elem
       */
      function NgxDomarrowComponent(elem) {
      ...
      _createClass(NgxDomarrowComponent, [{
        key: "getNumberOrDef",
        value: function getNumberOrDef(val, def) {
        ...
        key: "inside",
        value: function inside(minX, minY, maxX, maxY, x1, y1) {
        ...
        value: function intersectionPoint(x1, y1, x2, y2, minX, minY, maxX, maxY) {
          /** @type {?} */
          var min = Math.min;
          /** @type {?} */
          ...
          var good = this.inside.bind(null, min(x1, x2), min(y1, y2), max(x1, x2), max(y1, y2));
          if (x1 <= minX && x2 <= minX || y1 <= minY && y2 <= minY || x1 >= maxX && x2 >= maxX || y1 >= maxY && y2 >= maxY || this.inside(minX, minY, maxX, maxY, x1, y1) && this.inside(minX, minY, maxX, maxY, x2, y2)) return null;
          /** @type {?} */
        ...
        key: "adjustLine",
        value: function adjustLine(nth, from, to) {
          ...
          var fT = fromBStartY + fromBHeight * this.getNumberOrDef(this.fromY, 0.5);
          /** @type {?} */

          var tT = toBStartY + toBHeight * this.getNumberOrDef(this.toY, 0.5);
          /** @type {?} */

          var fL = fromBStartX + fromBWidth * this.getNumberOrDef(this.fromX, 0.5);
          /** @type {?} */

          var tL = toBStartX + toBWidth * this.getNumberOrDef(this.toX, 0.5);
          /** @type {?} */
          ...
          if ((fT >= tT || fL >= tL) && (tT >= fT || tL >= fL)) ANG *= -1;

          if (this.onlyVisible) {
            /** @type {?} */
            var arrangeFrom = this.intersectionPoint(fL, fT, tL, tT, fromBStartX, fromBStartY, fromBStartX + fromBWidth, fromBStartY + fromBHeight);
            /** @type {?} */

            var arrangeTo = this.intersectionPoint(fL, fT, tL, tT, toBStartX, toBStartY, toBStartX + toBWidth, toBStartY + toBHeight);
          ...
          var arrows = this.elem.nativeElement.querySelectorAll('.line-' + nth + ' .arrow');
          this.needSwap[nth] = fL > tL || fL === tL && fT < tT;
          /** @type {?} */

          var arrowFw = this.needSwap[nth] && this.isVisible(arrows[0]) && arrows[0] || !this.needSwap[nth] && this.isVisible(arrows[1]) && arrows[1];
          /** @type {?} */

          var arrowBw = !this.needSwap[nth] && this.isVisible(arrows[0]) && arrows[0] || this.needSwap[nth] && this.isVisible(arrows[1]) && arrows[1];
          ...
          this.styleLine[nth]['background'] = 'linear-gradient(to right, ' + (arrowFw ? 'transparent' : color) + ' 11px, ' + color + ' 11px ' + (H - 11) + 'px, ' + (arrowBw ? 'transparent' : color) + ' ' + (H - 11) + 'px 100%)';
        ...
        value: function adjustLines() {
          ...
          */
          function (pair, i) {
            _this.adjustLine(i, pair[0], pair[1]);
          });
        }
        /**
         * @private
        ...
        key: "getFromToPairs",
        value: function getFromToPairs() {
          /** @type {?} */
          var froms = Array.from(
          /** @type {?} */
          document.querySelectorAll(this.from));
          /** @type {?} */
    ...
    NgxDomarrowComponent.ctorParameters = function () {
      return [{
    ...
    var NgxDomarrowModule = function NgxDomarrowModule() {
      _classCallCheck(this, NgxDomarrowModule);
    };
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_domarrow__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ngx-domarrow */
    "../dist/ngx-domarrow/fesm2015/ngx-domarrow.js");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], ngx_domarrow__WEBPACK_IMPORTED_MODULE_3__["NgxDomarrowModule"]],
      providers: [],
  ...
  function srcMainTs(module, __webpack_exports__, __webpack_require__) {
    ...
    if (_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].production) Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["enableProdMode"])();
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/samber/project/github.com/samber/ngx-domarrow/ngx-domarrow/demo/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
